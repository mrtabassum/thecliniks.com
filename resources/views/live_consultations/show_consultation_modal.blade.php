    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('messages.live_consultation.live_consultation_details') }}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-8">
                        <span class="fw-bolder fs-6 text-gray-800" id="consultationDates"></span>
                    </div>
                </div>
                <div class="row mb-7">
                ...
                <div class="row mb-7">
                    <label class="col-lg-4 fw-bold text-muted">{{ __('messages.appointment.patient').(' ').__('messages.common.name').(':')  }}</label>
                    <div class="col-lg-8">
                ...
                <div class="row mb-7">
                    <label
                            class="col-lg-4 fw-bold text-muted">{{ __('messages.doctor.doctor').(' ').__('messages.common.name').(':')  }}</label>
                    <div class="col-lg-8">
