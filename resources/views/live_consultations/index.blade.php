                ...
                @if(getLogInUser()->hasRole('doctor'))
                    ...
                    <div class="d-flex justify-content-end my-1" data-kt-user-table-toolbar="base">
                        <button type="button" class="btn btn-primary" id="addModalBtn">
                            ...
                            {{ __('messages.live_consultation.add_live_consultation') }}</button>
                    </div>
                </div>
            @endif
        </div>
        <div class="card-body pt-0 fs-6 py-8 px-8 overflow-auto px-lg-10 text-gray-700">
