            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::select('patient_id', $patients, null, ['class' => 'form-select form-select-solid edit-patient-name', 'placeholder' => 'Select Patient Name', 'id' => 'editPatientName', 'required', 'data-control'=>'select2', 'data-dropdown-parent'=>'#editModal']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::select('doctor_id', $doctors, null, ['class' => 'form-select form-select-solid edit-doctor-name', 'aria-label' => 'Select Doctor Name', 'required', 'id' => 'editDoctorName','data-control'=>'select2', 'data-dropdown-parent'=>'#editModal']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
