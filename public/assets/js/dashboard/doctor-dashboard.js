      ...
      if (result.success) {
        ...
        if (result.data.patients.data != '') {
          $.each(result.data.patients.data, function (index, value) {
            ...
            $(document).find('#monthlyReport').append(prepareTemplateRender('#doctorDashboardTemplate', data));
          });
        } else {
      ...
      if (result.success) {
        ...
        if (result.data.patients.data != '') {
          $.each(result.data.patients.data, function (index, value) {
            ...
            $(document).find('#weeklyReport').append(prepareTemplateRender('#doctorDashboardTemplate', data));
          });
        } else {
      ...
      if (result.success) {
        ...
        if (result.data.patients.data != '') {
          $.each(result.data.patients.data, function (index, value) {
            ...
            $(document).find('#dailyReport').append(prepareTemplateRender('#doctorDashboardTemplate', data));
          });
        } else {
